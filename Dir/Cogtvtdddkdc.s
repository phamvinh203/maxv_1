...
<dir table="xcdvtdd0" code="ky, nam, ma_yt, ma_sp, ma_bp, so_lsx, ma_vt" order="ky, nam, ma_yt, ma_sp, ma_bp, so_lsx, ma_vt" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_yt" isPrimaryKey="true" allowNulls="false" clientDefault="Default">
      ...
      <items style="AutoComplete" controller="Factor" reference="ten_yt%l" key="status = '1' and kieu_yt = '1'" check="kieu_yt = '1'" information="ma_yt$xdmyt.ten_yt%l" row ="1"/>
    </field>
    ...
    <field name="sl_dk" type="Decimal" dataFormatString="@quantityInputFormat">
  ...
  <views>
    <view id="Dir">
      ...
      <item value="111: [sl_dk].Label, [sl_dk], [ky]"/>
      <item value="111: [dd_dk_nt].Label, [dd_dk_nt], [nam]"/>
      <item value="11: [dd_dk].Label, [dd_dk]"/>
    </view>
  </views>
  ...
  <commands>
    <command event="Showing">
      <text>
        <![CDATA[<encrypted>a6qNZSiN1/1LfcSaBpUEXsk7fhGGdmyudZPLtFHi5H2daVO7X1qJkV5z8rsL1lJAKiz/hfk+YKI8R6EQPrqf6d4K14+RvwOVLIwxzGe+Sbc=</encrypted>]]>
      </text>
    </command>
