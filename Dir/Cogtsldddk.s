...
<dir table="xcdloaiytdd" code="ky, nam, loai_yt, ma_sp, ma_bp, so_lsx" order="ky, nam, loai_yt, ma_sp, ma_bp, so_lsx" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="tl_ht" type="Decimal" dataFormatString="#00.00">
      <header v="Tỷ lệ hoàn thành" e="Finish Rate"></header>
      <footer v="%" e="%"></footer>
      <items style="Numeric"/>
      <clientScript><![CDATA[<encrypted>w4PMMhDwbdhdLsYtYCOa40GB1aTM7LTRxOuxNXSetvDH8Ps0EM6R4e2vJiWCF072l0j/CG4X7QlZpBYLx2wmTw==</encrypted>]]></clientScript>
    </field>
  ...
  <views>
    <view id="Dir">
      ...
      <item value="110: [sl_dd_ck].Label, [sl_dd_ck]"/>
    </view>
  </views>
  ...
  <script>
    <text>
      <![CDATA[<encrypted></encrypted>]]>
    </text>
  </script>
</dir>
