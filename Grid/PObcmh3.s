...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng kê hóa đơn mua hàng, dịch vụ" e="Purchase, Service Invoice Listing"></title>
  ...
  <fields>
    ...
    <field name="so_ct" width="0" allowSorting="true" allowFilter="true" align="right" hidden="true">
    ...
    <field name="pt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
