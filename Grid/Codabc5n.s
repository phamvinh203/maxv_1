...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
	...
	<fields>
		...
		<field name="ma_vv" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'codabc5ndetail', Controller: 'Codabc5n', Name: '[ma_vv]', Value: '$func.trim([ma_vv]) + String.fromCharCode(253) + $func.trim([tk]) + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
