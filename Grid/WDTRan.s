...
<grid table="m69$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PX6" uniKey="true" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="ngay_ct" type="DateTime" dataFormatString="@datetimeFormat" width="90"  allowFilter="true">
      <header v="Ngày xuất" e="Issue Date"></header>
    </field>
    ...
    <field name="t_so_luong" type="Decimal" dataFormatString="@quantityViewFormat" width="120" clientDefault="0"  allowFilter="true">
  ...
  <commands>
    <command event="Loading">
      <text>
        ...
        <![CDATA[<encrypted>wXmaJyxSIu6MwMh5Npy7ejBowABNapa1MxSc9hlHI+Crk0t0Youz1hXvp6laAyDim9DgqIemkKmBeA99QuFCspSXDuh9r0IcVfrvHquQVH2pXwoWrIekC6QyIFvUnA0Agk2wKB5K5GdMbhzV49tkylCb0+fxQMc/BNdfJqNNMPneLaFI+uL4RJnUj3HG2F4HECZSYcncziIHT/fieC4/4FfEu7tZkVI6LHZ7DFeJ1NA=</encrypted>]]>
