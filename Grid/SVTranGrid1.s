...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="gia2" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Giá bán" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>
    <field name="tien2" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" allowSorting="true" width="100">
      <header v="Tiền hàng" e="Amount"></header>
      <items style="Numeric"/>
    </field>
	<field name="tl_ck" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="% CK" e="Amount"></header>
      <items style="Numeric"/>
    </field> 
	<field name="ck_nt" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" allowSorting="true" width="100">
      <header v="Tiền CK" e="Amount"></header>
      <items style="Numeric"/>
    </field> 
    <field name="ma_kho" width="100" allowSorting="true" aliasName="a">
      <header v="Kho" e="Site ID"></header>
    </field>
	<field name="ma_vv" width="100" aliasName="a"  allowFilter="true">
      <header v="Dự án" e="Project ID"></header>
    </field>
	<field name="ma_hd" width="100" aliasName="a"  allowFilter="true">
      <header v="Hợp đồng" e="Contract"></header>
    </field>
	<field name="tk_vt" width="90" allowSorting="true" aliasName="a">
      <header v="Tk vt" e="Inven.acct"></header>
    </field>
	<field name="tk_dt" width="90" allowSorting="true" aliasName="a">
      <header v="Tk dt" e="Re. acct"></header>
    </field>
    <field name="tk_gv" width="90" allowSorting="true" aliasName="a">
      <header v="Tk gv" e="COGS.acct"></header>
    </field>
	<field name="tk_ck" width="90" allowSorting="true" aliasName="a">
      <header v="Tk ck" e="Dis.acct"></header>
    </field>	
