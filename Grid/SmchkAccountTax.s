...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Kiểm tra số liệu giữa sổ tài khoản và sổ thuế" e="VAT list and Account Activity Reconciliation Checking"></title>
  <subTitle v="Từ ngày %d1 đến ngày %d2, tài khoản thuế: %s..." e="Date from %d1 to %d2, Tax Account: %s..."></subTitle>
  <fields>
    ...
    <field name="kt1" width="200" type="Boolean" allowSorting="true" allowFilter="true">
      <header v="Không có trên sổ thuế" e="Not exist in VAT"></header>
    </field>
