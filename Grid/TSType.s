...
<grid table="dmplcc" code="ma_loai" order="ma_loai" xmlns="urn:schemas-maxv-com:data-grid">
  
  <title v="Danh mục loại CCDC" e="Tool &#38; Supply Type List"></title>
  <subTitle v="Cập nhật loại CCDC (Thêm, sửa, xóa, ...)" e="Tool &#38; Supply Type (Add, Edit, Delete, ...)"></subTitle>
  ...
  <fields>
    ...
    <field name="ten_loai%l" width="300" allowSorting="true" allowFilter="true">
      <header v="Tên loại" e="Name"></header>
    </field>
  </fields>
