...
<grid table="m25$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="HB4" uniKey="true" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Hóa đơn điều chỉnh giá hàng bán" e="Sales Price Adjustment Invoice"></title>
  <subTitle v="Cập nhật hóa đơn điều chỉnh giá hàng bán (Thêm, sửa, xóa, in, ...) " e="Sales Price Adjustment Invoice (Add, Edit, Delete, Print, ...)"></subTitle>
