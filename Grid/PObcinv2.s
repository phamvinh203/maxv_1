...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng kê chi tiết trả tiền cho các hóa đơn" e="Detail Payment Transaction List by Invoice"></title>
  ...
  <fields>
    ...
    <field name="tt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Đã trả nt" e="FC Amt. Paid"></header>
    </field>
    <field name="con_pt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Phải trả nt" e="FC Amt. Payable"></header>
    </field>
    ...
    <field name="tt" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Đã trả" e="Amt. Paid"></header>
    </field>
    <field name="con_pt" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Phải trả" e="Amt. Payable"></header>
    </field>
