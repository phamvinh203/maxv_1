...
<grid table="dmnhvv" code="loai_nh, ma_nh" order="loai_nh, ma_nh" xmlns="urn:schemas-maxv-com:data-grid">
  
  <title v="Danh mục phân nhóm dự án, công trình" e="Project Group List"></title>
  <subTitle v="Cập nhật phân nhóm dự án, công trình (Thêm, sửa, xóa, ...)" e="Project Group (Add, Edit, Delete, ...)"></subTitle>
