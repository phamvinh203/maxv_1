...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid" valid="systotal = 1">
  ...
  <fields>
	...
	<field name="so_ton_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Số tồn nt" e="FC Debit End"></header>
    </field>
	...
	<field name="so_ton" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="120" allowFilter="true" allowSorting="true" aggregate="Sum">
      <header v="Số tồn" e="Debit End Amount"></header>
    </field>
