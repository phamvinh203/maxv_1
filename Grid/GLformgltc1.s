...
<grid table="v20gltc1" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Khai báo bảng cân đối kế toán" e="Balance Sheet Declaration"></title>
