...
<grid table="ctgt30" code="stt_rec" filter="ma_ct = 'T03' and &FilterCheckAccessUnit;" order="ma_dvcs, ngay_ct, ngay_ct0, ma_kh" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Cập nhật hóa đơn GTGT đầu vào" e="VAT Invoice Input Entry"></title>
  <subTitle v="Cập nhật hóa đơn GTGT đầu vào (Thêm, sửa, xóa, ...)" e="VAT Invoice Input (Add New, Edit, Delete, ...)"></subTitle>
  ...
  <fields>
    ...
    <field name="ngay_ct" type="DateTime" dataFormatString="@datetimeFormat" width="100" allowSorting="true" allowFilter="true">
      <header v="Ngày chứng từ" e="Posting Date"></header>
    </field>
    <field name="so_ct" width="100" align="right">
      <header v="Số chứng từ" e="Voucher Number"></header>
    </field>
    <field name="ngay_ct0" type="DateTime" dataFormatString="@datetimeFormat" width="100" allowSorting="true" allowFilter="true">
      <header v="Ngày hóa đơn" e="Invoice Date"></header>
    </field>
    <field name="so_ct0" width="100" align="right" allowSorting="true" allowFilter="true">
      <header v="Số hóa đơn" e="Invoice Number"></header>
    </field>
    <field name="so_seri0" width="100" align="right" allowSorting="true" allowFilter="true">
    ...
    <field name="t_tien" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" clientDefault="0" allowSorting="true" allowFilter="true">
