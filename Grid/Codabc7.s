...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid" valid="systotal = 1">
  <title v="Báo cáo KQ SXKD dự án, công trình" e="Income Statement by Project/Job"></title>
  <subTitle v="Từ ngày %d1 đến ngày %d2..." e="Date from %d1 to %d2..."></subTitle>
  <pivot rowField="ma_vv" columnField="sysColumn" dataFields="tien, tien_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="3"/>
  <fields>
    ...
    <field name="tien" type="Decimal" width="110" dataFormatString="@baseCurrencyAmountViewFormat" allowFilter="true" allowSorting="true" aggregate="Sum">
      <header v="" e=""></header>
    </field>
    <field name="tien_nt" type="Decimal" width="100" dataFormatString="@foreignCurrencyAmountViewFormat" allowFilter="true" allowSorting="true" aggregate="Sum">
      <header v="" e=""></header>
    </field>
