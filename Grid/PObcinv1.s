...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng kê công nợ phải trả theo hóa đơn" e="Payable Report by Invoice"></title>
  ...
  <fields>
    ...
    <field name="ten_kh%l" width="250" allowSorting="true" external="true" allowFilter="true">
      <header v="Tên nhà cung cấp" e="Supplier Name"></header>
    </field>

    <field name="t_tt_nt0" type="Decimal" width="100" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Số tiền nt" e="FC Amount"></header>
    </field>
    <field name="t_tt_nt1" type="Decimal"  width="100" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Đã trả nt" e="Paid FC Amt."></header>
    </field>
    <field name="con_pt_nt" type="Decimal" width="100" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Phải trả nt" e="Payment FC Amt."></header>
    </field>
    <field name="ty_gia" type="Decimal" width="100" dataFormatString="@exchangeRateViewFormat" allowSorting="true">
      <header v="Tỷ giá" e="Exchange Rate"></header>
    </field>

    <field name="t_tt0" type="Decimal" width="110" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Số tiền" e="Amount"></header>
    </field>
    <field name="t_tt1" type="Decimal" width="110" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Đã trả" e="Paid Amt."></header>
    </field>
    <field name="con_pt" type="Decimal" width="110" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Phải trả" e="Payment Amt."></header>
    </field>
    ...
    <field name="ngay_tt0" type="DateTime" dataFormatString="@datetimeFormat" width ="90" allowSorting="true" allowFilter="true">
