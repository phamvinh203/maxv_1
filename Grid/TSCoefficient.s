...
<grid table="vwthhspbcc" code="nam, ky, so_the_ts, tk_kh, tk_cp, ma_bp_cc, ma_vv, ma_bp, ma_hd, so_lsx, ma_phi" filter="&FilterCheckAccessUnit;" order="nam, ky, so_the_ts, tk_kh, tk_cp, ma_bp_cc, ma_vv, ma_bp, ma_hd, so_lsx, ma_phi" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="tk_kh" isPrimaryKey="true" width="100">
      <header v="Tk chờ phân bổ" e="Allocation Acct."></header>
    </field>
    <field name="tk_cp" isPrimaryKey="true" width="100">
      <header v="Tk chi phí" e="Expense Acct."></header>
    </field>
    <field name="ma_bp_cc" isPrimaryKey="true" width="100">
