...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="tk_co" width="100" allowSorting="true" aliasName="a">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        <![CDATA[<encrypted>GbJt5VJTwe5RB00t4MUaETVfdT9A36zQw+JukQhsxLft6Bub+yOymGr7gjXEIfPoluSatnJHt2iHt2cG7iJCru0Gr+hPNn8EaeBOfffNQqB0Pa1KSwvahp13fhzrCT56BthP241Y1t7JdmdfWwP2XNRnMSpgvckY9yC9gJGIy69hVtoXbmvlIYWYP7/hm1cy</encrypted>]]>
      </text>
    </query>
  </queries>
  <script>
