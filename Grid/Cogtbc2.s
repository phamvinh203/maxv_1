...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Báo cáo giá thành sản phẩm theo nhóm yếu tố" e="Cost of Product by Cost Factor Group"></title>
  <subTitle v="Từ kỳ %d1 năm %n1 đến kỳ %d2 năm %n2..." e="From Period %d1 Year %n1 to Period %d2 Year %n2..."></subTitle>
  <pivot rowField="xPivot" columnField="sysColumn" dataFields="gt, gt_nt" indexTable="2" indexColumn="1" indexHeader="2" indexView="5"/>
  <fields>
