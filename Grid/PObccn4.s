...
<grid type="Report" valid="sysorder = 6" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Sổ đối chiếu công nợ" e="Supplier AR/AP Comparison Book"></title>
  <subTitle v="Tài khoản: %s1, nhà cung cấp: %s2%s3, hóa đơn từ ngày %d1 đến ngày %d2..." e="Account: %s1, Supplier: %s2%s3, Invoice Date from %d1 to %d2..."></subTitle>
