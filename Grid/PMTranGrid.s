...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="ten_vt%l" readOnly="true" external="true" defaultValue="''" width="250" allowSorting="true" aliasName="b">
      <header v="Tên mặt hàng" e="Item Description"></header>
    </field>
    <field name="dvt" width="60" allowSorting="true" aliasName="a">
      <header v="Đvt" e="Voucher No."></header>
    </field>
	<field name="ma_kho" width="100" allowSorting="true" aliasName="a">
      <header v="Mã kho" e="Site Code"></header>
    </field>
	<field name="tk_vt" width="70" allowSorting="true" aliasName="a">
    ...
    <field name="gia_nt0" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Đơn giá" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>	
    <field name="tien_nt0" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Thành tiền" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>		
    <field name="nk_nt" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Thuế nhập khẩu" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>			
    <field name="ttdb_nt" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Thuế TTĐB" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>				
    <field name="cp_nt" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Chi phí" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>		
    <field name="gia_nt" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100" hidden="true">
      <header v="Giá mua" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>
    <field name="tien_nt" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" allowSorting="true" width="100" hidden="true">
