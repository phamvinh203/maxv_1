...
<grid table="m53$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PT0" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Phân bổ tiền hàng trả cho các hóa đơn" e="Cash Disbursement Allocation to Invoices"></title>
  <subTitle v="Cập nhật phân bổ tiền hàng trả cho các hóa đơn (Thêm, sửa, xóa, ...)" e="Cash Receipt Allocation (Add, Edit, Delete, ...)"></subTitle>
