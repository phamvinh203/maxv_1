...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="du_dau" allowFilter="true" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
    ...
    <field name="tien_nt_n" allowFilter="true" type="Decimal" width="0" hidden="true" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Tiền nhập nt" e="FC Receive Amt."></header>
    </field>
    <field name="tien_nhap" allowFilter="true" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
    ...
    <field name="tien_nt_x" allowFilter="true" type="Decimal" width="0"  hidden="true" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Tiền xuất nt" e="FC Issued Amt."></header>
    </field>
    <field name="tien_xuat" allowFilter="true" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
    ...
    <field name="du_cuoi_nt" allowFilter="true" type="Decimal" width="0" hidden="true" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
      <header v="Dư cuối nt" e="FC Closing Amt."></header>
    </field>
    <field name="du_cuoi" allowFilter="true" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" aggregate="Sum">
