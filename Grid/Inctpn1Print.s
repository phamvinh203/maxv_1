...
<grid type="Report" code="stt_rec" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="ten_kh" width="250" external="true" allowSorting="true" allowFilter="true" readOnly="true">
      <header v="Tên khách hàng" e="Customer Name"></header>
    </field>
	<field name="dien_giai" width="300" external="true" allowSorting="true" allowFilter="true" readOnly="true">
      <header v="Diễn giải" e="Description"></header>
    </field>
    <field name="t_tt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="110" allowSorting="true" readOnly="true" allowFilter="true" aggregate="Sum">
...
<commands>
  ...
  <response>
     <action id="Print1">
      <text>
        <![CDATA[<encrypted></encrypted>]]>
      </text>
    </action>
  </response>
