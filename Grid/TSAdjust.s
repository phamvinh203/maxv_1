...
<grid table="vctdmcc1" code="so_the_ts, ngay_ct, ma_nv, ky, nam, ma_tg_ts" filter="&FilterCheckAccessUnit;" order="so_the_ts, ngay_ct, ma_nv, ky, nam, ma_tg_ts" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Điều chỉnh giá trị" e="Tool &#38; Supply Value Adjustment"></title>
  <subTitle v="Điều chỉnh giá trị CCDC (Thêm, sửa, xóa, ...)" e="Tool, Supply Value Adjustment (Add, Edit, Delete, ...)"></subTitle>

  <fields>
    <field name="so_the_ts" isPrimaryKey="true" width="100" allowSorting="true" allowFilter="true">
      <header v="Mã công cụ" e="Tool &#38; Suplly"></header>
    </field>
