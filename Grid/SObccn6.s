...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Báo cáo số dư công nợ" e="Customer Balance Summary"></title>
  <subTitle v="Tài khoản: %s1, dư đến ngày %d1..." e="Account: %s1, Date: %d1..."></subTitle>
  ...
  <fields>
    ...
    <field name="du_co_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
