...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Báo cáo tổng hợp chi phí so sánh giữa hai kỳ theo đơn vị cơ sở" e="Expenses Arising Comparison between Two Periods By Unit"></title>
  ...
  <fields>
    ...
    <field name="ps2" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="ps_nt2" type="Decimal" width="120" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Kỳ 2" e="Period 2"></header>
    </field>
    
    <field name="ps_cl" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Chênh lệch" e="Difference"></header>
    </field>
    <field name="ps_cl_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Chênh lệch" e="Difference"></header>
    </field>
    <field name="ty_le_cl" type="Decimal" width="100" dataFormatString="##.#0" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="% Chênh lệch" e="% Difference"></header>
    </field>
    <field name="ty_le_cl_nt" type="Decimal" width="100" dataFormatString="##.#0" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="% Chênh lệch" e="% Difference"></header>
    </field>
