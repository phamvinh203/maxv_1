...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="so_phieu" width="100" allowSorting="true">
      <header v="Số phiếu thu" e="No."></header>
    </field>
    <field name="ngay_phieu" type="DateTime" dataFormatString="@datetimeFormat" width="80" allowSorting="true">
      <header v="Ngày thu" e="Date"></header>
    </field>

    <field name="so_hd" width="100" allowSorting="true">
      <header v="Số hóa đơn" e="Invoice No."></header>
    </field>
    <field name="ngay_hd" type="DateTime" dataFormatString="@datetimeFormat" width="100" allowSorting="true">
      <header v="Ngày hóa đơn" e="Invoice Date"></header>
    </field>
	
	<field name="tien_nt" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" allowSorting="true" width="100">
      <header v="Tiền thu" e="Amount"></header>
      <items style="Numeric"/>
    </field>
	<field name="ma_nt" allowSorting="true" width="80">
      <header v="Mã nt" e="Currency"></header>
    </field>
	<field name="ty_gia" type="Decimal" dataFormatString="@exchangeRateInputFormat" allowSorting="true" width="100">
      <header v="Tỷ giá" e="Ex. Rate"></header>
      <items style="Numeric"/>
    </field>
	
	
    <field name="tt" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" allowSorting="true" width="100">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        <![CDATA[<encrypted>EMoWhgcR3HcdnUf9Cp3IjNM5DJ9nuOA785bKXqt9ViIDdzgFapRHo9PuHw8ZvhqkWzlfsGKe4rG8vf10m5AYA9fxCATAK07oEkUO7xagwrmAgSXXwmgauiKh3euYHuRxA1P9IX0DC+3gtAUdMin6Ow==</encrypted>]]>
      </text>
    </query>
  </queries>
  <script>
