...
<grid table="dmnhvt" code="loai_nh, ma_nh" order="loai_nh, ma_nh" xmlns="urn:schemas-maxv-com:data-grid">

  <title v="Danh mục phân nhóm hàng hóa, vật tư" e="Item Group List"></title>
  <subTitle v="Cập nhật phân nhóm hàng hóa, vật tư (Thêm, sửa, xóa, ...)" e="Item Group (Add, Edit, Delete, ...)"></subTitle>
