...
<grid table="ctctts" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="3" id="TS1" uniKey="true" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="" e=""></title>
  <subTitle v="" e=""></subTitle>
  <partition table="ctctts" prime="ctctts" inquiry="its" field="ngay_ct" expression="''" increase="{0}" default=""/>
  <fields>
