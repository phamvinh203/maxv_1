...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Tổng hợp nhập xuất tồn theo kho" e="Stock Summary by Site"></title>
  <subTitle v="Từ ngày %d1 đến ngày %d2..." e="Date from %d1 to %d2..."></subTitle>
  <fields>
    <field name="stt" type="Int16" width="30" allowSorting="true" allowFilter="true">
      <header v="Stt" e="No."></header>
    </field>
    <field name="ma_vt" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'inbctk3detail', Controller: 'INbctk3', Name: '[ma_vt]', Value: '[ma_vt] + this._queryFilterString + String.fromCharCode(253) + [ma_kho]'}, Script: 'beforeDrillDownWithCondition(this);'">
