...
<grid table="dmthuettdb" code="ma_thue" order="ma_thue" xmlns="urn:schemas-maxv-com:data-grid">
  
  <title v="Danh mục thuế suất thuế tiêu thụ đặc biệt" e="Excise Tax List"></title>
  <subTitle v="Cập nhật thuế thuế suất thuế TTĐB (Thêm, sửa, xóa, ...)" e="Excise Tax (Add, Edit, Delete, ...)"></subTitle>
