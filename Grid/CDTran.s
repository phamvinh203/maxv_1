...
<grid table="m51$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="PC1" uniKey="true" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Phiếu chi tiền mặt" e="Cash Disbursement"></title>
  <subTitle v="Cập nhật phiếu chi tiền mặt (Thêm, sửa, xóa, in, ...)" e="Cash Disbursement (Add, Edit, Delete, Print, ...)"></subTitle>
  ...
  <fields>
    ...
    <field name="so_ct" width="80" align="right"  allowFilter="true">
      <header v="Số chứng từ" e="VC number"></header>
    </field>
    ...
    <field name="ten_kh%l" width="220" external="true" aliasName="b"  allowFilter="true">
      <header v="Tên khách" e="Cust name"></header>
    </field>
    ...
    <field name="t_tt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" clientDefault="0.00"  allowFilter="true">
      <header v="Tiền" e="Total Amount"></header>
      <items style="Numeric"/>
    </field>
  ...
  <commands>
    <command event="Loading">
      <text>
        ...
        <![CDATA[<encrypted>wXmaJyxSIu6MwMh5Npy7er3sp/7X4ioz560P09nnW1XSDvHHkEplU9TUgaQRWxxTr8mFD6VBSZAKpkgh1H2cKLNWe1vqT/H+vPPn/CqZk/+OKdG0GKzzKQ0h8Fd+CS9oXHjqi1myK6gBuCReGyDg4Xy5ETiONek9S5GAhc3m5Uz3ZKv+CFAwrU0aZZ58lJR2T5P1A3lqCFl9w42CZcAjd+IjAoPOkSTnpjoKkFixjeo=</encrypted>]]>
  ...
  <script>
    <text>
      <![CDATA[<encrypted></encrypted>]]>
      &DowloadScript;
    </text>
  </script>
