...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng kê chi phí NVL dự án, công trình" e="Material Cost Sheet By Job"></title>
  ...
  <fields>
    ...
    <field name="ma_nx" width="100" allowSorting="true" allowFilter="true" hidden="true">
      <header v="Tà khoản" e="Account"></header>
    </field>
