...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng tính chi phí CCDC" e="Tool &amp; Supply Allocation Report"></title>
  ...
  <fields>
    ...
    <field name="gt_da_kh_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="gt_kh_ky_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Gt pb nt trong kỳ" e="FC Distr. in Period"></header>
    </field>
    ...
    <field name="gt_da_kh" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="120" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="tk_kh" width="100" allowSorting="true" allowFilter="true">
      <header v="Tk chờ phân bổ" e="Acc time"></header>
    </field>
