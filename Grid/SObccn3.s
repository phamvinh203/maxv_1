...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid" valid="systotal = 1">
  <title v="Bảng cân đối phát sinh công nợ trên nhiều tài khoản" e="Customer Balance of Multi - Account"></title>
  ...
  <fields>
    ...
    <field name="ma_kh" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'SObccn3Detail', Controller: 'SObccn3', Name: '[ma_kh]', Value: '[ma_kh] + String.fromCharCode(253) + [tk] + this._queryFilterString + String.fromCharCode(253) + [no_dk] + String.fromCharCode(253) + [no_dk_nt] + String.fromCharCode(253) + [co_dk]+ String.fromCharCode(253) + [co_dk_nt] + String.fromCharCode(253) + [ps_no]+ String.fromCharCode(253) + [ps_no_nt] + String.fromCharCode(253) + [ps_co]+ String.fromCharCode(253) + [ps_co_nt] + String.fromCharCode(253) + [no_ck] + String.fromCharCode(253) + [no_ck_nt] + String.fromCharCode(253) + [co_ck]+ String.fromCharCode(253) + [co_ck_nt]'}, Script: 'beforeDrillDown(this);'">
