...
<grid table="dmthuenk" code="ma_thue" order="ma_thue" xmlns="urn:schemas-maxv-com:data-grid">
  
  <title v="Danh mục thuế suất thuế nhập khẩu" e="Import Tax List"></title>
  <subTitle v="Cập nhật thuế thuế suất thuế nhập khẩu (Thêm, sửa, xóa, ...)" e="Import Tax (Add, Edit, Delete, ...)"></subTitle>
  ...
  <fields>
	...
	<field name="thue_suat" type="Decimal" width="100" allowSorting="true" allowFilter="true">
