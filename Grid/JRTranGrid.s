...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="ten_kh%l" readOnly="true" external="true" defaultValue="''" width="280" allowSorting="true" aliasName="b">
	...
	<field name="ma_vv" width="100" allowFilter="true">
      <header v="Dự án" e="Project"></header>
    </field>
	<field name="ma_hd" width="100" allowFilter="true">
