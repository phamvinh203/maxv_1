...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng phân bổ chi phí theo định mức NVL" e="Cost Aggregation and Allocation Detailed by Raw Material"></title>
  ...
  <fields>
    ...
    <field name="ma_yt" width="100" allowSorting="true" allowFilter="true">
      <header v="Mã ytcp" e="Factor ID"></header>
    </field>
    ...
    <field name="sl_sx" type="Decimal" dataFormatString="@quantityViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Sl sản xuất" e="Produce Q'ty"></header>
    </field>
    <field name="he_so_dv" type="Decimal" dataFormatString="#.#0" width="100" allowSorting="true" allowFilter="true">
      <header v="Hệ số đơn vị" e="Unit Coefficient"></header>
    </field>
    <field name="he_so" type="Decimal" dataFormatString="#.#0" width="100" allowSorting="true" allowFilter="true">
      <header v="Tổng hệ số" e="Total Coefficient"></header>
    </field>
    <field name="sl_tk" type="Decimal" dataFormatString="@quantityViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
