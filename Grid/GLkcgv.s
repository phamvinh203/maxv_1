...
<grid table="vdmkcgv" code="stt" order="stt" xmlns="urn:schemas-maxv-com:data-grid">

  <title v="Khai báo bút toán kết chuyển giá vốn" e="Gross Transfer Declare"></title>
  <subTitle v="Khai báo bút toán kết chuyển giá vốn (Thêm, sửa, xóa, ...) " e="Gross Transfer Declare (Add, Edit, Delete, ...)"></subTitle>
  <fields>
