...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid" valid="systotal = 1">
  <title v="Bảng kê hóa đơn điện tử mua vào" e="Input VAT EInvoice Listing"></title>
  ...
  <fields>
    ...
    <field name="mst_ngban" width="100" allowSorting="true" allowFilter="true">
      <header v="MST/người bán" e="Tax Code"></header>
    </field>	
    <field name="ten_ngban" width="250" allowSorting="true" allowFilter="true">
      <header v="Tên người bán" e="Name Customer"></header>
    </field>
    ...
    <field name="ck_nt" type="Decimal" width="100" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Tiền CK" e="Discount Amout"></header>
    </field>
    <field name="ck" type="Decimal" width="100" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Tiền CK" e="Discount Amout"></header>
    </field>
    <field name="tien_nt" type="Decimal" width="110" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Tiền chưa thuế" e="FC Credit Amount"></header>
    </field>
    ...
    <field name="thue_nt" type="Decimal" width="100" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="tt_nt" type="Decimal" width="110" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Tiền sau thuế" e="FC Credit Amount"></header>
    </field>
    ...
    <field name="tl_ck" width="60" allowSorting="true" allowFilter="true" align="right">
      <header v="TL CKTM" e="Rate Discount"></header>
    </field>
    <field name="thue_suat" width="60" allowSorting="true" allowFilter="true" align="right">
