...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid" valid="systotal = 1">
  <title v="Bảng kê phiếu xuất trả lại nhà cung cấp" e="Rerurn to Supplier Listing"></title>
  ...
  <fields>
    ...
    <field name="gia_nt" type="Decimal" width="100" dataFormatString="@foreignCurrencyPriceViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="gia" type="Decimal" width="100" dataFormatString="@baseCurrencyPriceViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
