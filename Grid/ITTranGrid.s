...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
	...
	<field name="TK_du" width="100" allowSorting="true" aliasName="a">
      <header v="Tk Nợ" e="Dr Acc"></header>
    </field>
    <field name="TK_vt" width="100" allowSorting="true" aliasName="a">
      <header v="Tk Có" e="Cr Acc"></header>
    </field>	
	<field name="Ma_bp" width="100" allowSorting="true" aliasName="a">
      <header v="Phòng ban" e="Dept code"></header>
    </field>
    <field name="Ma_kho" width="100" allowSorting="true" aliasName="a">
      <header v="Kho xuất" e="Site code"></header>
    </field>
	<field name="Ma_khon" width="100" allowSorting="true" aliasName="a">
      <header v="Kho nhập" e="Site code"></header>
    </field>
