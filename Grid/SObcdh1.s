...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng kê đơn hàng bán/Hợp đồng" e="Sales Order Listing"></title>
  <subTitle v="Đơn hàng từ ngày %d1 đến ngày %d2..." e="Date from %d1 to %d2..."></subTitle>
  <fields>
    <field name="ngay_ct" type="DateTime" width="90" dataFormatString="@datetimeFormat" allowSorting="true" allowFilter="true">
      <header v="Ngày đơn hàng/HĐ" e="VC. Date"></header>
    </field>
    ...
    <field name="so_ct" width="90" align="right" allowSorting="true" allowFilter="true">
      <header v="Số đơn hàng/HĐ" e="PO No."></header>
    </field>
    ...
    <field name="gia_nt" type="Decimal" dataFormatString="@foreignCurrencyPriceViewFormat" width="100" allowSorting="true">
      <header v="Đơn giá nt" e="FC Purchase Price"></header>
    </field>
    <field name="tien_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" aggregate="Sum">
      <header v="Thành tiền nt" e="FC Purchase Amount"></header>
    </field>
    <field name="thue_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" aggregate="Sum" hidden="true">
      <header v="Thuế nt" e="Total Amount"></header>
    </field>
    <field name="tt_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" aggregate="Sum">
      <header v="Tổng thanh toán nt" e="Total Amount"></header>
    </field>
    <field name="ty_gia" type="Decimal" dataFormatString="@foreignCurrencyPriceViewFormat" width="100" allowSorting="true">
    ...
    <field name="thue" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" aggregate="Sum" hidden="true">
      <header v="Thuế" e="Tax"></header>
    </field>
    <field name="tt" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" aggregate="Sum">
      <header v="Tổng thanh toán" e="Total amount"></header>
    </field>
    <field name="ngay_giao" type="DateTime" width="90" dataFormatString="@datetimeFormat" allowSorting="true" allowFilter="true">
