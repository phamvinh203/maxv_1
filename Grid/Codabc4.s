...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Sổ chi tiết dự án, công trình" e="Job Activity"></title>
  <subTitle v="Tài khoản: %s1, Dự án: %s2 - %s3, từ ngày %d1 đến ngày %d2..." e="Account: %s1, Job: %s2 - %s3, Date from %d1 to %d2..."></subTitle>
  <fields>
    ...
    <field name="so_ct" type="String" width="90" align="right" allowSorting="true" allowFilter="true">
      <header v="Số chứng từ" e="Voucher No."></header>
    </field>
    <field name="ma_kh" type="String" width="100" allowSorting="true" allowFilter="true">
      <header v="Mã khách" e="Customer"></header>
    </field>
    <field name="ten_kh%l" type="String" width="250" allowSorting="true" allowFilter="true">
    ...
    <field name="ps_no_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" aggregate="Sum">
      <header v="Phát sinh nợ nt" e="FC Debit Amount"></header>
    </field>
    <field name="ps_co_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" aggregate="Sum">
    ...
    <field name="ps_no" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" aggregate="Sum">
      <header v="Phát sinh nợ" e="Debit Amount"></header>
    </field>
    <field name="ps_co" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" aggregate="Sum">
