...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="gia0" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Đơn giá" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>
    <field name="tien0" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Thành tiền" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>	
    <field name="cp" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100">
      <header v="Chi phí" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>
    <field name="gia" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="100" hidden="true">
      <header v="Đơn giá chi phí" e="Sales Price"></header>
      <items style="Numeric"/>
    </field>	
	...
	<field name="dh_so" width="100" allowFilter="true" hidden="true">
      <header v="Số ĐH" e="Contract No"></header>
    </field>	
