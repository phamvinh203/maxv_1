...
<grid type="Report" valid="systotal = 1" filter="excel &lt;> 2" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Bảng kê hóa đơn hàng hóa, dịch vụ bán ra" e="Output VAT Invoice Listing"></title>
  ...
  <fields>
    ...
    <field name="ma_mau_ct" width="80" allowSorting="true" allowFilter="true" hidden="true">
    ...
    <field name="t_tien_nt2" type="Decimal" width="110" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Tiền bán nt" e="Selling FC Amount"></header>
    </field>
    <field name="t_tien2" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="t_thue_nt" type="Decimal" width="110" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="ghi_chu" width="200" allowSorting="true" allowFilter="true">
