...
<grid type="Report" valid="systotal = 0" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <title v="Sổ nhật ký thu tiền" e="Cash Receipt Journal"></title>
  ...
  <fields>
    ...
    <field name="so_ct" type="String" width="90" allowSorting="true" allowFilter="true" align="right">
    ...
    <field name="t_tien_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi nợ nt" e="FC Debit Amount"></header>
      <footer v="%s nt" e="FC %s"></footer>
    </field>
    <field name="tien_nt1" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có nt 1" e="FC Credit Amount 1"></header>
      <footer v="%s nt" e="FC %s"></footer>
    </field>
    <field name="tien_nt2" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có nt 2" e="FC Credit Amount 2"></header>
      <footer v="%s nt" e="FC %s"></footer>
    </field>
    <field name="tien_nt3" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có nt 3" e="FC Credit Amount 3"></header>
      <footer v="%s nt" e="FC %s"></footer>
    </field>
    <field name="tien_nt4" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có nt 4" e="FC Credit Amount 4"></header>
      <footer v="%s nt" e="FC %s"></footer>
    </field>
    <field name="tien_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="100" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có nt khác" e="FC Credit Amount"></header>
    </field>
    ...
    <field name="tien1" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" allowFilter="true" aggregate="Sum">
    ...
    <field name="tien3" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có 3" e="Credit Amount 3"></header>
    </field>
    <field name="tien4" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có 4" e="Credit Amount 4"></header>
    </field>
    <field name="tien" type="Decimal" dataFormatString="@baseCurrencyAmountViewFormat" width="110" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="Ghi có khác" e="Credit Amount"></header>
    </field>

    <field name="tk_du" type="String" width="100" allowSorting="true" allowFilter="true">
      <header v="Tk có khác" e="Credit Account"></header>
    </field>
