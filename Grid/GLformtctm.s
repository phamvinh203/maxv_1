...
<grid table="v30gltctm" code="form, stt, ma_so" order="form, stt, ma_so" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Khai báo mẫu thuyết minh tài chính" e="Interpretation of Financial Declaration"></title>
  ...
  <fields>
    ...
    <field name="tk" width="150">
      <header v="Tài khoản" e="Accounts"></header>
    </field>
    <field name="tk_du" width="150">
      <header v="Tk đối ứng" e="Reference Accounts"></header>
    </field>
    <field name="tk_0_gt" width="150">
      <header v="Tk không tính giảm trừ" e="None Deduction Accounts"></header>
    </field>
  </fields>
