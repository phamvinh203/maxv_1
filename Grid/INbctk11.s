...
<grid type="Report" valid ="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Báo cáo hàng hóa, vật tư cận ngày" e="Due-to-expire Stock Report"></title>
  ...
  <fields>
    ...
    <field name="han_sd" width="100" type="DateTime" dataFormatString="@datetimeFormat" allowSorting="true" allowFilter="true">
      <header v="Hạn sử dụng" e="Expire Date"></header>
    </field>
    <field name="so_ngay_cl" type="Decimal" dataFormatString="# ### ###" width="100" allowSorting="true" allowFilter="true">
      <header v="Số ngày còn lại" e="Remain Days"></header>
    ...
    <field name="sl_ton" type="Decimal" width="100" dataFormatString="@quantityViewFormat" allowSorting="true" allowFilter="true" aggregate="Sum">
      <header v="SL tồn" e="Stock Q'ty"></header>
    </field>
