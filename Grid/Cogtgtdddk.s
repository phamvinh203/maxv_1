...
<grid table="vxcdytddx" code="ky, nam, ma_sp, ma_bp, so_lsx, ma_yt" order="ky, nam, ma_sp, ma_bp, so_lsx, ma_yt" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Cập nhật giá trị dở dang đầu kỳ theo yếu tố chi phí" e="Opening WIP Balance Input by Cost Factor"></title>
  <subTitle v="Thêm, sửa, xóa giá trị dở dang đầu kỳ theo yếu tố chi phí..." e="New, Edit, Delete Opening WIP Balance by Cost Factor..."></subTitle>
