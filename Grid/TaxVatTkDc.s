...
<grid table="glthue328_luu" code="ma_dvcs, ma_so, ky, nam" filter="&FilterCheckAccessUnit;" order="ma_dvcs, ma_so, ky, nam" xmlns="urn:schemas-moka-com:data-grid">
  <title v="Điều chỉnh số liệu tờ khai thuế giá trị gia tăng" e="VAT Declaration Adjustment"></title>
  ...
  <fields>
    ...
    <field name="ds" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true">
      <header v="Doanh số" e="Revenue"></header>
    </field>
    <field name="ds_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true">
      <header v="Doanh số nt" e="FC Revenue"></header>
    </field>
    <field name="thue" type="Decimal" width="120" dataFormatString="@baseCurrencyAmountViewFormat" allowSorting="true">
      <header v="Thuế" e="VAT"></header>
      <items style="Numeric"/>
    </field>
    <field name="thue_nt" type="Decimal" width="120" dataFormatString="@foreignCurrencyAmountViewFormat" allowSorting="true">
