...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Tổng hợp hàng xuất kho" e="Summary Report on Goods Issued"></title>
  <subTitle v="Từ ngày %d1 đến ngày %d2..." e="Date from %d1 to %d2..."></subTitle>
  <fields>
    <field name="stt" type="Int16" width="30" dataFormatString="# ###" allowSorting="true" allowFilter="true">
      <header v="Stt" e="No."></header>
    </field>
    <field name="ma_vt" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'inbcxk4detail', Controller: 'INbcxk4', Name: '[ma_vt]', Value: '[ma_vt] + String.fromCharCode(253) + [ma_sp] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
