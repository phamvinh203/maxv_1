...
<grid type="Report" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Các lệnh sản xuất đã kết thúc kỳ trước nhưng vẫn có phát sinh" e="MOs have been Finished in the Previous Period, still Arise"></title>
  <subTitle v="Kỳ %d1 năm %n1." e="Period %d1 year %n1."></subTitle>
  <fields>
    <field name="so_lsx" width="80" align="right" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/Voucher.ashx Query: {Name: '[ma_ct]', Value: '[stt_rec]'}, Script: 'beforeDrillDown(this);'">
