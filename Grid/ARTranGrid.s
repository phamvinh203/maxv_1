...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="tk_dt" width="100" allowSorting="true" aliasName="a">
      <header v="Tài khoản" e="Account"></header>
    </field>
    <field name="ten_tk%l" readOnly="true" external="true" defaultValue="''" width="250" allowSorting="true" aliasName="b">
      <header v="Tên tài khoản" e="Name"></header>
    </field>
    <field name="tien_nt2" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" allowSorting="true" width="100">
      <header v="Tiền" e="Amount"></header>
      <items style="Numeric"/>
    </field>
	<field name="tl_ck" type="Decimal" dataFormatString="@baseCurrencyPriceInputFormat" allowSorting="true" width="80">
      <header v="TL chiết khấu" e="Amount"></header>
      <items style="Numeric"/>
    </field> 
	...
	<field name="thue_nt" type="Decimal" dataFormatString="@baseCurrencyAmountInputFormat" allowSorting="true" width="100">
      <header v="Thuế" e="Tax Amount"></header>
      <items style="Numeric"/>
    </field> 
	<field name="tk_ck" width="70" allowSorting="true" aliasName="a">
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        <![CDATA[<encrypted>GbJt5VJTwe5RB00t4MUaEbhcqqrKPnwXgYR8gNlZ4C870WCh4+RJtTmEfpKZmhwe5cPPPFPPdIssFhHVsz5Tu/lVmqCcLSyVSnyjWqo45RVOzTLDxiOO/1hWKN3oXRPQ9ri8OUJ2jAV08ab/gF37yx/VWm83Akj1RTKDbgBvdETSn/zTaz362g+6dYSDHT3E</encrypted>]]>
      </text>
    </query>
  </queries>
  <script>
