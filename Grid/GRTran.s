...
<grid table="m23$000000" code="stt_rec" order="ngay_ct, so_ct" type="Voucher" id="HB5" uniKey="true" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Hóa đơn dịch vụ trả lại" e="Services Sale Return Invoice"></title>
  <subTitle v="Cập nhật hóa đơn dịch vụ trả lại (Thêm, sửa, xóa, in, ....)" e="Services Sale Return Invoice (Add, Edit, Delete, Print, ...)"></subTitle>
  ...
  <fields>
	...
	<field name="Dien_giai" width="280" aliasName="a" allowFilter="true">
