...
<!DOCTYPE grid [
  ...
  <!ENTITY f ", t_tt: '[t_tt]:=[t_tt]', t_tt_nt: '[t_tt_nt]:=[t_tt_nt]'">
]>

<grid table="r60$000000" code="stt_rec" order="stt_rec, line_nbr" type="Detail" freezeColumns="2" id="SO1" uniKey="true" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="" e=""></title>
  <subTitle v="" e=""></subTitle>
  <partition table="c64$000000" prime="r60$" inquiry="i64$" field="ngay_ct" expression="convert(char(6), {0}, 112)" increase="dateadd(month, 1, {0})" default="000000"/>
  <fields>
    &XMLChargeFields;
  </fields>
