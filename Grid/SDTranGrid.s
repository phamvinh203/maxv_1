...
<grid table="" code="" order="stt_rec, stt_rec0" type="Detail" freezeColumns="3" xmlns="urn:schemas-maxv-com:data-grid">
  ...
  <fields>
    ...
    <field name="tk_no" width="100" allowSorting="true" aliasName="a">
	...
	<field name="ma_bp" width="100" allowSorting="true" aliasName="a">
      <header v="Bộ phận" e="Contract"></header>
    </field>  
  ...
  <queries>
    ...
    <query event="Finding">
      <text>
        <![CDATA[<encrypted>GbJt5VJTwe5RB00t4MUaETVfdT9A36zQw+JukQhsxLft6Bub+yOymGr7gjXEIfPoluSatnJHt2iHt2cG7iJCru0Gr+hPNn8EaeBOfffNQqB0Pa1KSwvahp13fhzrCT56SHKI3aaTOA2hS+UWQ3mRb50oZ+wpyRmvD+BinZNdHXqu7uD7b8pW1JXzy5TJmIBP</encrypted>]]>
      </text>
    </query>
  </queries>
  <script>
