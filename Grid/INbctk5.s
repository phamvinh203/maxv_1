...
<grid type="Report" valid="systotal = 1" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Tổng hợp nhập xuất tồn theo lô" e="Stock Summary by Lot"></title>
  ...
  <fields>
    ...
    <field name="ma" width="100" allowSorting="true" allowFilter="true" hyperlinkFormatString="~/AppHandler/View.ashx Query: {Page: 'inbctk5detail', Controller: 'INbctk5', Name: '[ma]', Value: '[ma_vt]+ String.fromCharCode(253)+[ma_lo] + this._queryFilterString'}, Script: 'beforeDrillDownWithCondition(this);'">
    ...
    <field name="ma_lo" width="0" hidden="true">
      <header v="" e=""></header>
    </field>
