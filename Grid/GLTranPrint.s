...
<grid type="Report" code="stt_rec" xmlns="urn:schemas-maxv-com:data-grid">
  <title v="Phiếu kế toán tổng hợp" e="Cash Receipt"></title>
  ...
  <fields>
    ...
    <field name="dien_giai" width="350" allowSorting="true" allowFilter="true" readOnly="true">
    ...
    <field name="so_ct" width="100" allowSorting="true" allowFilter="true" readOnly="true" hyperlinkFormatString="~/AppHandler/Voucher.ashx Query: {Name: '[ma_ct]', Value: '[stt_rec]'}, Script: 'beforeDrillDown(this);'">
      <header v="Số chứng từ" e="Number"></header>
    </field>
    <field name="ps_no_nt" type="Decimal" dataFormatString="@foreignCurrencyAmountViewFormat" width="120" allowSorting="true" readOnly="true" aggregate="Sum" allowFilter="true">
 ...
 <commands>
  ...
  <response>
     <action id="Print1">
      <text>
        <![CDATA[<encrypted></encrypted>]]>
      </text>
    </action>
  </response>
