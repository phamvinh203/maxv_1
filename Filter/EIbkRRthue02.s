...
<dir id="1" type="Report" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="kind" dataFormatString="1, 2, *" clientDefault="1" align="right">
      ...
      <footer v=" 1 - HĐĐT bán ra, 2 - Hóa đơn đã hạch toán (Kê khai), * - Tất cả" e="1 - Einvoice, 1 - Invoice GL, * - All"></footer>
      <items style="Mask"/>
    </field>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<encrypted>647JQIc009OaK20CLaB6Y58XYmaITbJQ+v1lZqgAEzp0ZdoDP99393Sbjeb5pv+Qi3jrUIYe40NEQFrD0e4k/ydzM3RKVt3gS1iH/YhrxzC03sVcIsbltxCQakgfPRyki2Lia0oXwmehPLqWj6F9rak/xFERqXCZ4LusuauKPM7XDISI3Ag9jcbIflwhFFPJUIDaw5nV3bUGyh8sr0k2kw==</encrypted>]]>
      </text>
    </command>
  </commands>
