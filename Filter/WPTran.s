...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d54">
]>

<dir table="m54$000000" code="stt_rec" order="ngay_ct, so_ct" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_nt_hd" categoryIndex="1" filterSource="detail" operation="20">
      <header v="Mã ngoại tệ" e="Currency"></header>
      <items style="AutoComplete" controller="Currency" reference="ten_nt_hd%l" key="status = '1'" check="1=1"/>
    </field>
    <field name="ten_nt_hd%l" readOnly="true" external="true">
      <header v="" e=""></header>
    </field>
  ...
  <views>
    <view id="Dir" height="64">
      ...
      <item value="11010: [ma_nt_hd].Label, [ma_nt_hd], [ten_nt_hd%l]"/>
