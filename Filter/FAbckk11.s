...
<!DOCTYPE dir [
  ...
  <!ENTITY Form "FABCKK11">
]>

<dir id="0" type="Report" xmlns="urn:schemas-maxv-com:data-dir">
  <title v="Điều kiện lọc" e="Filter Condition"></title>
  <fields>
    <field name="ky" type="Int16" dataFormatString="#0" allowNulls="false" aliasName="Period" defaultValue="(new Date()).getMonth() + 1;">
      <header v="Kỳ" e="Period"></header>
      <footer v="Kỳ/năm" e="Period/Year"></footer>
      <items style="Numeric"></items>
    </field>
    <field name="nam" type="Int16" dataFormatString="###0" allowNulls="false" aliasName="Year" defaultValue="(new Date()).getFullYear()">
 ...
 <command event="Showing">
    ...
    <command event="Processing">
      <text>
        <![CDATA[<encrypted>EMoWhgcR3HcdnUf9Cp3IjOPuZWfwlJTkziH2yvHFfWi28e/bbu7XR8EXx1DFbz1qRa4qSSnLV96IBO9HcV1mETEoVqFAdKVFN+zGnJ2HkC/ajyyvOMMco1aJ/pefNC167QGseNbcUTAo87pndMKt1g==</encrypted>]]>
      </text>
    </command>
  ...
  <script>
    <text>
      &OutlineEntry;
      <![CDATA[<encrypted></encrypted>]]>
