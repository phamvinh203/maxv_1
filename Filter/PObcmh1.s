...
<dir type="Report" id="1" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
	...
	<field name="nh_theo" aliasName="nh_theoSobcmh1" clientDefault="1">
  ...
  <views>
    <view id="Dir" height="210">
      <item value="125, 25, 80, 105, 105, 60, 0"/>
      ...
      <categories>
        <category index="1" columns="120, 20, 85, 105, 105, 50">
          <header v="Thông tin chung" e="General"/>
        </category>
        <category index="2" columns="120, 20, 80, 100, 130, 60">
          <header v="Lựa chọn" e="Option"/>
        </category>
        <category index="9" columns="120, 20, 85, 100, 100, 60">
 ...
 <command event="Showing">
    ...
    <command event="Processing">
      <text>
        <![CDATA[<encrypted>Let80D0Zwu9iY9cytyoFKvUVNBXDDKosuvJqBVaY10jSRODsw+t2L1ivibC+IJBBpRDWmRNl0JH2TZFRBKxObV7idltLFvk41t+9VbnoyvzoHKwk1WEaoRcwndbSgQ7pBP5PP8N7V7v7T0/x73rnLbbx6MussXAItJhiKy6HQwE=</encrypted>]]>&Identity;<![CDATA[<encrypted></encrypted>]]>
      </text>
    </command>
  </commands>
  ...
  <script>
    <text>
      ...
      <![CDATA[<encrypted></encrypted>]]>
    </text>
  </script>
