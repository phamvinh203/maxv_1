...
<dir table="cttt20" code="stt_rec" order="ngay_ct, so_ct" xmlns="urn:schemas-maxv-com:data-dir">
	...
	<fields>
		...
		<field name="dpb" external="true" clientDefault="0" defaultValue="0" rows="258" categoryIndex="1">
			<header v="" e=""></header>
			<label v="Chi tiết" e="Detail"></label >
			<items style="Grid" controller="CApbtt1AutoAllocateGrid" row="1">
	...
	<views>
		<view id="Dir" height="328" anchor="6" split="10">
			<item value="100, 110, 237, 100, 8, 58, 42, 18, 110, 0, 0, 0"/>
	...
	<commands>
		...
		<command event="Inserting">
			<text>
				<![CDATA[<encrypted>vp0bzF0O1Q1IdFZocguDTrXeQ+tMlR27PGiEveakoPz7lg1ZU2yHfe3VjPvDORqFcYQUwVib14TiiXKv1jvXcnvDzpuxo9Hi2OXGl+y5too9N9dCFRBZH0iawjkUNM5sjBwPvds+kMBiPedBDPa/qg==</encrypted>]]>
			</text>
		</command>
	...
	<response>
		<action id="stt">
			<text>
				<![CDATA[<encrypted>PCOs/4QYuSCRfE2jl7z5/7SC4FTbT4h418GqdpTYCdZKZy3ENNm5HQfWaUUjE5VsVFyzBRk5q/ejxtfPrUJT1ySitxeogrykctkRKe8dfCqDt3/6ZfMIuapEMpGyrNnm9QoEfzFH9eumG7pWmrzavg1EnAi8HPtk6LFkBEGxU5PwtdPsw9Z12I0Pzdv/FiA5kffWtOsdICYss/fCl9oGZ8GV+mysxGv7O+JLJko/0q8=</encrypted>]]>
			</text>
		</action>
	</response>
</dir>
