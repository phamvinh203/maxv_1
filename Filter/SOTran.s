...
<dir table="m64$000000" code="stt_rec" order="ngay_ct, so_ct" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_nvbh" filterSource="master" operation="10">
    ...
    <field name="status" dataFormatString="*, 0, 1, 2, 3, 4, 5" clientDefault="*" align="right" inactivate="true" categoryIndex="-1">
      <header v="Trạng thái" e="Status"></header>
      <footer v="Ký tự &lt;span style=&quot;color:#008200;&quot;&gt;[*]&lt;/span&gt; - Hiện tất cả" e="&lt;span style=&quot;color:#008200;&quot;&gt;[*]&lt;/span&gt; - Show all"></footer>
      <items style="Mask"/>
    </field>
  ...
  <views>
    <view id="Dir" height="64">
	  ...
	  <item value="11010: [ma_nvbh].Label, [ma_nvbh], [ten_nvbh%l]"/>
