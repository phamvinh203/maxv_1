...
<dir id="0" type="Report" xmlns="urn:schemas-maxv-com:data-dir">
	...
	<fields>
		<field name="ngay_tu" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="fromDate" defaultValue="new Date()">
			<header v="Ngày hạch toán từ ngày" e="GL Date from"></header>
	...
	<views>
		<view id="Dir" height="126">
			<item value="130, 30, 20, 60, 110, 100, 130, 0"/>
			...
			<item value="11001001: [ma_kh].Label, [ma_kh], [ten_kh%l], [tk]"/>
	...
	<commands>
		...
		<command event="Processing">
			<text>
				<![CDATA[<encrypted>HSEfj6zv0Zay3ROcGijPQyYZ9upOsNzZEWer8Jwhvtez6uPK0YOELeO8hEl9quRI8WvkrUIAPEDuAj09Hhef+718/txwEqMSiDmA4kAo3Im/O8EZXXzvbbTlsOVLRN4EowYGlskVQlBrvwqCigeaJ6LuMmmU4z0Upt69WDDuPC8=</encrypted>]]>
			</text>
		</command>
	</commands>
