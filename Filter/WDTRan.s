...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d69">
]>

<dir table="m69$000000" code="stt_rec" order="ngay_ct, so_ct" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_gd" categoryIndex="9" filterSource="master" operation="20">
      ...
      <items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'PX6' and status = '1'" check="ma_ct = 'PX6'"/>
    </field>
    ...
    <field name="ma_nx" filterSource="detail" operation="40" categoryIndex="1">
      ...
      <items style="AutoComplete" controller="Reason" reference="ten_nx%l" key="1 = 1" check="1 = 1" information="&TableDetail;"/>
    </field>
  ...
  <views>
    <view id="Dir" height="112">
      ...
      <item value="11010: [tk_vt].Label, [tk_vt], [ten_vt%l]"/>
  ...
  <script>
    <text>
      &ScriptFilterInit;
      <![CDATA[<encrypted></encrypted>]]>
    </text>
  </script>
