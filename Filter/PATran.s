...
<dir table="m83$000000" code="stt_rec" order="ngay_ct, so_ct" xmlns="urn:schemas-maxv-com:data-dir">
	...
	<fields>
		...
		<field name="ma_gd" categoryIndex="9" filterSource="master" operation="10">
			...
			<items style="AutoComplete" controller="TransactionCode" reference="ten_gd%l" key="ma_ct = 'HM4' and status = '1' " check="ma_ct = 'HM4'" />
		</field>
		...
		<field name="tk_vt" categoryIndex="1" filterSource="detail" operation="30">
			...
			<items style="AutoComplete" controller="Account" reference="ten_tk_vt%l" key="loai_tk = 1 and status = '1'" check="loai_tk = 1" information="&TableDetail;"/>
		</field>
	...
	<views>
		<view id="Dir" height="88">
			...
			<categories>
				...
				<category index="9" columns="120, 30, 70, 100, 230, 0">
