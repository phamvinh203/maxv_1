...
<dir id="0" type="Report" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_nx" filterSource="detail" categoryIndex="1" operation="40">
      <header v="Tài khoản nợ" e="Reason Code"></header>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<encrypted>pjes3H3PCrih6xvOxthc+GRvqHhftbI1Ra5vqibsHKzM7rSv8YyiYW+guhEktZWln71dqd3r1nWJ98EkFBCrECmj30ZE/VoWrsnIPbRETInaXtTfATbmxUy3+HvIozfMeV1Pqq0Q8UNpbxCNHd9UuDTwU0YjzjL+w3L1WClLGlY3DG4RmNuZCFP4Id3vp7Cm</encrypted>]]>
      </text>
    </command>
  </commands>
