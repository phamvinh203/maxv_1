...
<dir table="cttt30" code="stt_rec" order="ma_dvcs, ngay_ct, ma_kh, ma_dvcs" xmlns="urn:schemas-maxv-com:data-dir">
  <title v="Lọc chi tiết hóa đơn" e="Invoice Detail Filter"></title>
  <fields>
    <field name="ngay_ct1" type="DateTime" dataFormatString="@datetimeFormat" align="left" allowNulls="false" aliasName="fromDate" defaultValue="new Date()">
      <header v="Hóa đơn từ/đến ngày" e="Date from/to"></header>
    </field>
