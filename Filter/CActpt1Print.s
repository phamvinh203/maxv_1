...
<dir id="0" type="Report" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="tk_co" categoryIndex="1" filterSource="detail" operation="10">
      ...
      <items style="AutoComplete" controller="Account" reference="ten_tk_co%l" key="status = '1'" check="1 = 1"/>
    </field>
  ...
  <commands>
    ...
    <command event="Processing">
      <text>
        <![CDATA[<encrypted>qf8owdz7/6tdQN2VJGiX8KwC7iKrulPZ7wSaON72rLuMwP7UbvManaY6dxl3A6q7umy9pNzuYAazv95Yzq1DU6ry8i2T2LEBp+8+s98WYzZq4iSTlxik/8Xqwbx6/quHQB6/AwRgquPKd1Rbpfrl0E76II85egwSz6ciNT5iCVWEZbn5GeIXozHm72NBTdvg</encrypted>]]>
      </text>
    </command>
  </commands>
