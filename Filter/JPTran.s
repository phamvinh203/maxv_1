...
<!DOCTYPE dir [
  ...
  <!ENTITY TableDetail "d39">
]>

<dir table="m39$000000" code="stt_rec" order="ngay_ct, so_ct" xmlns="urn:schemas-maxv-com:data-dir">
  ...
  <fields>
    ...
    <field name="ma_kh" categoryIndex="1" filterSource="detail" operation="20">
      ...
      <items style="AutoComplete" controller="Customer" reference="ten_kh%l" key="status = '1'" check="1 = 1" information="&TableDetail;"/>
    </field>
